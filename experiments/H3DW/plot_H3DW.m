...
ref_construct_complexity = ref_construct_complexity / ref_construct_complexity(1) * htlr_construct_time_list(1) / 4;
...
xticks([10^5, 10^6, 10^7, 10^8]);
xtickformat('%.0e');
yticks([10^1, 10^2, 10^3, 10^4]);
ytickformat('%.0e');
legend("Location", "southeast", "Interpreter", "latex");
set(gca, 'FontSize', 30);
saveas(gcf, "./figure/H3DW_construct_time.png", "png");
exportgraphics(gcf, "./figure/H3DW_construct_time.pdf", ...
    "ContentType", "vector");
...
ref_hmultv_complexity = ref_hmultv_complexity / ref_hmultv_complexity(1) * htlr_hmultv_time_list(1) / 4;
...
legend("Location", "southeast", "Interpreter", "latex");
set(gca, 'FontSize', 30);
saveas(gcf, "./figure/H3DW_hmultv_time.png", "png");
exportgraphics(gcf, "./figure/H3DW_hmultv_time.pdf", ...
    "ContentType", "vector");
...
legend("Location", "southeast", "Interpreter", "latex");
set(gca, 'FontSize', 30);
saveas(gcf, "./figure/H3DW_memory.png", "png");
exportgraphics(gcf, "./figure/H3DW_memory.pdf", ...
    "ContentType", "vector");
...
legend("Location", "southeast", "Interpreter", "latex");
set(gca, 'FontSize', 30);
saveas(gcf, "./figure/H3DW_err.png", "png");
exportgraphics(gcf, "./figure/H3DW_err.pdf", ...
    "ContentType", "vector");
