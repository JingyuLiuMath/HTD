...
saveas(gcf, "./figure/H3DW_construct_time.eps", "epsc");
...
saveas(gcf, "./figure/H3DW_hmultv_time.eps", "epsc");
...
saveas(gcf, "./figure/H3DW_memory.eps", "epsc");
...
saveas(gcf, "./figure/H3DW_err.eps", "epsc");
