...
exportgraphics(gcf, "./figure/H3DS_construct_time.pdf", ...
    "ContentType", "vector");
...
exportgraphics(gcf, "./figure/H3DS_hmultv_time.pdf", ...
    "ContentType", "vector");
...
exportgraphics(gcf, "./figure/H3DS_memory.pdf", ...
    "ContentType", "vector");
...
exportgraphics(gcf, "./figure/H3DS_err.pdf", ...
    "ContentType", "vector");
