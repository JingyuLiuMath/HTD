...
fprintf("        \\bottomrule\n");
fprintf("    \\end{tabular}\n");
fprintf("    \\caption{Numerical results of $\\mathcal{H}$-matrices and HTD for the Helmholtz kernel\n");
fprintf("    under strong admissibility in \\(2\\)D.} \\label{tab:H2DS}\n");
fprintf("\\end{table}\n\n");
