...
hmat_n_list = [256, 512, 1024, 2048, 4096, 8192, 16384];
num_hmat_n = length(hmat_n_list);
hmat_N_list = hmat_n_list.^2;

htlr_n_list = [256, 512, 1024, 2048, 4096, 8192, 16384];
...
exportgraphics(gcf, "./figure/H2DW_construct_time.pdf", ...
    "ContentType", "vector");
...
exportgraphics(gcf, "./figure/H2DW_hmultv_time.pdf", ...
    "ContentType", "vector");
...
exportgraphics(gcf, "./figure/H2DW_memory.pdf", ...
    "ContentType", "vector");
...
exportgraphics(gcf, "./figure/H2DW_err.pdf", ...
    "ContentType", "vector");
